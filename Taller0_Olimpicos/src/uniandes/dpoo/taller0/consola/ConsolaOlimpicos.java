...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisAtleta()
	{
		...
		String atletaInput = input("Por favor ingrese el nombre del atleta").toLowerCase();
		String paisEncontrado = calculadora.buscarPaisAtleta(atletaInput);
		if (paisEncontrado != null) {
			System.out.println("El país del atleta " + atletaInput + " es " + paisEncontrado);
		}else {
